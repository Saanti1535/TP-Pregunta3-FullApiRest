...
class Bootstrap {
	...
	var pregunta03 = new PreguntaSimple => [ pregunta = "¿¿¿¿????"; id = 3; opciones = #["Opcion 1", "Opcion 2", "Opcion 3"]]
	var pregunta04 = new PreguntaSimple => [ pregunta = "pregunta04"; id = 4; opciones = #["Opcion 1", "Opcion 2", "Opcion 3"]]
	var pregunta05 = new PreguntaSimple => [ pregunta = "pregunta05"; id = 5; opciones = #["Opcion 1", "Opcion 2", "Opcion 3"]]
	var pregunta06 = new PreguntaSimple => [ pregunta = "pregunta06"; id = 6; opciones = #["Opcion 1", "Opcion 2", "Opcion 3"]]
	var pregunta07 = new PreguntaSimple => [ pregunta = "pregunta07"; id = 7; opciones = #["Opcion 1", "Opcion 2", "Opcion 3"]]
	var pregunta08 = new PreguntaSimple => [ pregunta = "pregunta08"; id = 8; opciones = #["Opcion 1", "Opcion 2", "Opcion 3"]]
